(() => {
    ...
    const copy = {
        ua: {
            ...
            carouselExtension: "HTML → Figma · розширення для Chrome",
            ...
            taskOneDescription: "Дизайн каруселі для Instagram",
        ...
        en: {
            ...
            carouselExtension: "HTML → Figma · Chrome extension",
            ...
            taskOneLabel: "Task 1",
            taskOneHeading: "Carousel",
            taskOneDescription: "Instagram carousel design",
    ...
    if (reducedMotion) {
        const processPreview = document.querySelector(".process-loop video");
        if (processPreview) { processPreview.autoplay = false; processPreview.pause(); }
    }
